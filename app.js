...
document.getElementById('op').onclick = function op (){
    ...
    document.getElementById('block-friend').style.display = 'none';
}
document.getElementById('te').onclick = function te (){
    document.getElementById('block_dec').style.display = 'none';
    document.getElementById('block-test').style.display = 'block';
    document.getElementById('block-zadach').style.display = 'none';
    document.getElementById('block-friend').style.display = 'none';
}
document.getElementById('za').onclick = function za (){
    document.getElementById('block_dec').style.display = 'none';
    document.getElementById('block-test').style.display = 'none';
    document.getElementById('block-zadach').style.display = 'block';
    document.getElementById('block-friend').style.display = 'none';
}
document.getElementById('dr').onclick = function dr (){
    document.getElementById('block_dec').style.display = 'none';
    document.getElementById('block-test').style.display = 'none';
    document.getElementById('block-zadach').style.display = 'none';
    document.getElementById('block-friend').style.display = 'block';
}
document.getElementById('testBth').onclick = function testBth(){
    ...
    document.getElementById('testBth').style.display = 'none';
}
